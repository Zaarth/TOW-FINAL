function scr_textos(){
	switch npc_nome{
		case "Fase1":
			texto[0] = "Precione E para interagir com o personagem e use o botão esquerdo do mouse para fechar o dialogo."
		break;
		case "Mercador":
		...
		break;
		case "Fase3":
			texto[0] = "A partir daqui não tem volta."
		case "Boss":
			texto[0] = "Tenho o pressentimento que algo perigoso está pela frente."
		break;
	}
}